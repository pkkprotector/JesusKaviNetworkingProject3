...
#This is the Client code for Project 3 which is the client side of the streaming of the video
#Created by Kavi Vasquez and Jonathan Thornton
#Date: 4/28/2014

#Requirements for the project:
#Impliment the actions that are taken when the buttons are pressed. 
...
class Client:
	...
	def sendRtspRequest(self, requestCode):
		...
		if requestCode == self.SETUP and self.state == self.INIT:
			...
			self.rtspSeq += 1       # Update RTSP sequence number.
